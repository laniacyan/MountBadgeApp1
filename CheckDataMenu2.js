...
//         {yearModal == false ? (
//           <View>
//             <Pressable onPress={() => setYearModal(true)}>
//               <Text>{year}</Text>
//             </Pressable>
//           </View>
//         ) : null}
...
//               renderItem={({ item }) => YearPicker(item)}
//             />
//           </View>
//         ) : null}
...
//   return (
//     <View style={{ flex: 0.7, width: "80%", marginTop: 10 }}>
//       {/* 날짜 입력 메뉴 */}
//       <View style={{ flex: 1, backgroundColor: "#E0E0F8" }}>
//         <Pressable
//           onPress={() => setModalVisible(!modalVisible)}
//           style={{ alignItems: "center" }}
//         >
//           <Text style={styles.AddDataButton}>산행 검색</Text>
//         </Pressable>
//         {/* 날짜 표시 메뉴 */}
//         <FlatList
//           style={{ marginTop: 30 }}
...
//               elevation: 5,
//             },
//             // { flex: dateInput == true ? 0.4 : 0.3 },
//             { height: dateInput == true ? "30%" : "50%" },
//           ]}
//         >
//           {/* 날짜 입력 */}
//           <View
